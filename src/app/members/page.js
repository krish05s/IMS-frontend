                        ...
                        >
                          ...
                          <td className="px-5 py-4">
                            <div className="flex items-center gap-2">
                              ...
                              >
                                <span
                                  className={`inline-block w-5 h-5 bg-white rounded-full shadow transform transition-transform duration-300 ${user.status == 1 ? "translate-x-6" : "translate-x-1"}`}
                                />
                              </button>
                              <span
                                className={`text-xs font-semibold ${user.status == 1 ? "text-emerald-600" : "text-slate-400"}`}
                              >
            ...
            <div className="bg-white rounded-2xl shadow-2xl w-full max-w-lg">
              ...
              <form onSubmit={handleEditSubmit} className="p-6 space-y-4">
                ...
                <p className="text-xs text-slate-400 bg-emerald-50 border border-emerald-100 rounded-xl px-3 py-2">
                  ...
                  from the toggle button in the table.
                </p>
