...
const routeMap = {
  ...
  "/todolist": { label: "To Do", icon: Icons.Todo },
...
export default function Topbar({ actions }) {
  ...
  return (
    <div className="fixed top-0 left-0 md:left-64 right-0 h-16 bg-white border-b border-[#f0f2f5] flex items-center px-4 md:px-6 z-50">
      {/* LEFT SIDE */}
      <div className="flex items-center gap-3 text-black">
        {/* ✅ Hamburger - Mobile Only - dispatches event to Sidebar */}
        <button
          onClick={() => window.dispatchEvent(new Event("toggleSidebarToggle"))}
          className="md:hidden flex items-center justify-center p-1 rounded-md hover:bg-slate-100 transition"
        ...
        {/* PAGE ICON */}
        <span className="flex items-center justify-center">{current.icon}</span>
