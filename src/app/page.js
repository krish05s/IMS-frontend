        ...
        <div className="flex-1 flex flex-col items-center justify-center px-10 py-12 bg-white">
          ...
          <div className="w-full max-w-xs">
            ...
            <button
              ...
              disabled={loading}
              className="w-full py-3.5 bg-orange-500 hover:bg-orange-600 active:bg-orange-700 disabled:bg-orange-300 disabled:cursor-not-allowed text-white text-base font-bold rounded-xl transition-all duration-200 shadow-lg shadow-orange-200 tracking-wide"
            >
